...
class StarRating extends Component {
  ...
  setRating = ev => {
    ...
    if ( this.props.currentRating % 1 !== 0 ) {
        ...
        remainder < 0.3 ? starArray[roundUp-1].innerHTML = '<img src="https://res.cloudinary.com/shakalondon/image/upload/v1637049769/Papaya/papaya-gray_mxtkm6.png" alt="Papaya Logo" className="mx-3 my-3" />' :
        remainder < 0.8 ? starArray[roundUp-1].innerHTML = '<img src="https://res.cloudinary.com/shakalondon/image/upload/v1637049769/Papaya/papaya-half_q68pbh.png" alt="Papaya Logo" className="mx-3 my-3"/>' :
        starArray[roundUp].innerHTML = '<img src="https://res.cloudinary.com/shakalondon/image/upload/v1637049769/Papaya/papaya-yellow_yqta5g.png" alt="Papaya Logo" className="mx-3 my-3"/>'
