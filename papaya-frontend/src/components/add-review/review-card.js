      ...
      <Card.Body>
            ...
            <Col md={12} className="px-2">
              <Row>
                ...
                <StarRating
                  ...
                  fontSize={"3rem"}
                  selected={(value) =>
                    setWriteReview({ ...writeReview, rating: value })
                  }
                />
              </Row>
            </Col>
        ...
        <Container className="px-2">
          ...
          <Form onSubmit={handleSubmit}>
            ...
            >
              <Form.Label>
                <h5 className="my-3 flex-row">Tell us about your experience</h5>
              </Form.Label>
            ...
            >
              <Form.Label>
                <h5 className="my-3">Give your review a title.</h5>
              </Form.Label>
            ...
            >
              <Form.Label>
                <h5 className="my-3">
                  Enter Booking Number OR Post code (optional)
                </h5>
              </Form.Label>
              <Form.Control
                type="text"
                aria-label="`Enter Order Information"
                name="orderRef"
                onChange={handleChange}
              ...
              />
              <Form.Text className="text-muted">
                Include your Trailfinders Booking Number OR Post code so it’s
                easier for Trailfinders to identify you and reply to your
                review.
              </Form.Text>
            </Form.Group>
            ...
            <Button className="w-100 my-3 profileButton" type="submit">
              Post Review
            </Button>
          </Form>
        </Container>
