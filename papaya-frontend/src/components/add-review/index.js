...
const setDirect = () => { // the callback. Use a better name
    console.log();
    setRedirect(true);
  };
    ...
    <>
        <Container fluid id="review-app-component" className="mx-0 d-flex justify-content-center px-0">
           {dataLoading ? <Container fluid id="business-form" className="flex-row mx-0 px-0"> 
            <LoadingSpinner/>
            </Container> : <Container fluid id="review-app" className="flex-row mx-0 px-0">
                
                <Row className="mx-0 px-0">
                    <ReviewNav user={userProf} profile={searchResult}/>
                </Row>
                <Row className="mx-0 px-0" id="review-main-cont">
                    <ReviewMain user={userProf} profile={searchResult} reDirect={setDirect}/>
                </Row>
            </Container>}
        </Container>
        <Footer/>
