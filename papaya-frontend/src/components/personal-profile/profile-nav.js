    ...
    >
        ...
        fluid
          ...
          <Navbar.Brand>
            ...
            {colorChangeState ? (
                  <h4 className="text-white mb-0 px-2">{userProf?.name}</h4>
                ) : (
                  <h1 className="text-white mb-0 px-3">{userProf?.name}</h1>
                )}
            </Container>
            <Container fluid className="px-0">
            {colorChangeState ? (
                  <h6 className="text-white mb-0 px-2">{`@${userProf?.username}`}</h6>
                ) : (
                  <h4 className="text-white mb-0 px-3">{`@${userProf?.username}`}</h4>
                )}
            </Container>
          </Navbar.Brand>
          ...
          <Navbar id="basic-navbar-nav" className="ms-auto">
            ...
            <Container className={`${colorChangeState? "user-stats px-4" : "user-stats px-0"}`}>
                <Row>
                  <Col xs={6} sm={6} md={6}>
                    <Container className="px-4">
                      <Row>
                        <Col md={12} xs={12} sm={12} className="d-flex justify-content-center">
                          <h1 className="profile-nav-number">{userProf?.reviews?.length}</h1>
                        </Col>
                      </Row>
