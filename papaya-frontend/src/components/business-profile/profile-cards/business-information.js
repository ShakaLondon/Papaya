import { faArrowRight, faCalendar, faCalendarAlt, faCheckCircle, faInfoCircle, faMapMarkerAlt, faPhone, faSearch, faStar, faThumbsUp } from '@fortawesome/free-solid-svg-icons';
    ...
    return (
        <Card style={{ width: '100%' }} className="my-4 pt-4 profileCard">
            ...
            <Card.Body className>
                ...
                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nunc eu ornare risus. Sed tempor quam eget consectetur consectetur. Maecenas eget elit sem. Pellentesque massa ligula, tempor eu congue in, mattis eu est. Suspendisse varius arcu at purus pulvinar tincidunt. Nunc eu sodales erat, id interdum orci. Sed vitae consectetur massa.

Phasellus lobortis, tellus sed euismod tincidunt, orci libero accumsan nulla, at fermentum lorem ligula auctor augue. Suspendisse et gravida ante, vel cursus massa. Aenean bibendum nisi leo, quis pharetra leo lacinia vel. Sed turpis risus, venenatis non ornare eget, dapibus nec nibh. Nulla pulvinar pellentesque lacus et consequat. Vivamus ligula nisl, volutpat sit amet tempus eu, dictum vehicula purus. Nullam tortor sem, tempor vel urna sit amet, semper posuere lorem. Etiam volutpat sapien id consectetur pharetra. Nunc pharetra sapien nulla, ac consectetur sapien aliquam non. Nullam dolor massa, pulvinar ac urna ac, iaculis porttitor nisi. Phasellus vel arcu ac dolor cursus placerat. Duis gravida justo at massa pharetra, ac porta tortor laoreet. Mauris ornare rhoncus elit sit amet finibus. Donec nunc ligula, imperdiet vel quam ut, viverra convallis arcu. Duis rutrum eros odio, quis aliquam libero ornare id. Ut bibendum ante non enim luctus, eu vehicula nunc condimentum.
                </Card.Text>
