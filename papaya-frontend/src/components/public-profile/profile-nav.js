  ...
  const changeNavbarColor = (scroll) => {
    ...
    return (
        <Navbar bg="light" expand="lg" className="py-0 px-0" id="profile-header">
            ...
            <Container fluid className="d-flex fullopacity" id="profile-container" style={{ paddingTop: `${ colorChangeState ? '100px' : '140px' }`}}>

                <Navbar.Brand><img src={profile.avatar?.avatar} alt="User Avatar" className="rounded-circle" style={{ width: "6rem", height: "6rem", objectFit: "cover" }}/></Navbar.Brand>
                <Navbar.Brand>
                    <Container fluid>
